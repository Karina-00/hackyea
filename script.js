...
{  
    ...
    {
        text = "It is definetely cold or very cold. Winter is coming.";
        document.getElementById('result').innerHTML+="<div><div class='termometr'><p></p></div><div class='napis'>"+x+"</br>"+y+z+" </br> "+temperat+"&#176C </br> "+wind+" m/s</br>"+chmurki+"</div></div>";
    }
    document.getElementById('result').innerHTML+="<div><div class='termometr'><p>"+text+"</p></div><div class='napis'>"+x+"</br>"+y+z+" </br> "+temperat+"&#176C </br> "+wind+" m/s</br>"+chmurki+"</div></div>";
    var text = "a"+wind+"b";
    let text = `a${wind?wind:'Brak danych'}b`
...
function weather()
{
    ...
    fetch('https://api.openweathermap.org/data/2.5/forecast?q='+city+'&appid=ae76d0efed32d9f29c4d54a5738b80ca').then((response) =>
    {
        console.log(this);
