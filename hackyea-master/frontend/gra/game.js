...
function start()
{
   ...
   if(los==0){
      losowySmiec.innerHTML = "<div><img style='max-height: 200px;' src='image/papier.png'></img></div>"
   }
   else if(los==1){
      losowySmiec.innerHTML = "<div><img style='max-height: 200px;' src='image/plastik.png'></img></div>"
   }
   else if(los==2){
      losowySmiec.innerHTML = "<div><img style='max-height: 200px;' src='image/szklo.jpg'></img></div>"
   }
   else if(los==3){
      losowySmiec.innerHTML = "<div><img style='max-height: 200px;' src='image/odpady.png'></img></div>"
   }
   ...
   boy.innerHTML = "<img src='image/chlopiec.png' style='height: 550px;'>"
